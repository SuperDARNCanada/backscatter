...
import numpy as np
import sys
import math  # REVIEW #42 library not used
# import mpmath as mpm  # REVIEW #33
from datetime import datetime  # REVIEW #42 library not used
...
class PowerDataPoints(object):
    ...
    def create_arrays(self, raw_data, lags, range_obj):
        ...
        mplgs = raw_data['mplgs']  # REVIEW #42 - mplgs is not used
    ...
    def remove_inf_points(self, non_inf_indices):  # TODO: DOCSTRING
        ...
        self.alpha_2 = self.alpha_2[mask]  # REVIEW #0 where is mask defined?
...
def _fit(raw_data, debug_mode=False):  # REVIEW #42 debug_mode not used, can use python logging library instead if you want
    ...
    range_list = []
    # num_ranges_with_data = len(raw_data['slist']) # REVIEW #33
